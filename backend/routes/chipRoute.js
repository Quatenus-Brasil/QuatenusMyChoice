...
router.post("/", authenticateUser, validate(createChipSchema), createChip);
router.get("/", authenticateUser, findAllChips);
router.get("/:id", authenticateUser, validId, findChipById);
router.delete("/:id", authenticateUser, validId, deleteChip);
router.patch("/:id", authenticateUser, validId, validate(editChipSchema), editChip);
